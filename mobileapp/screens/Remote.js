...
export default function Remote() {
  ...
  const handleShutDown = () => {
    axios
      .post("http://10.61.52.72:5001/perform/", {
    ...
    >
      <View>
        ...
        <TouchableOpacity style={styles.shutdown} onPress={handleShutDown}>
          ...
          >
            <Path
              d="M6.04229 7.84723C4.09555 9.79585 2.77037 12.278 2.23432 14.9798C1.69826 17.6816 1.97542 20.4816 3.03073 23.0259C4.08605 25.5701 5.87212 27.7443 8.1631 29.2735C10.4541 30.8027 13.1471 31.6181 15.9015 31.6168C18.6559 31.6155 21.3481 30.7974 23.6376 29.266C25.9271 27.7346 27.7111 25.5587 28.7639 23.0134C29.8168 20.4681 30.0912 17.6678 29.5525 14.9665C29.0138 12.2653 27.6863 9.7844 25.7376 7.83766M16.4304 1.08519L16.4304 14.4762"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        <TouchableOpacity style={styles.restart} onPress={handleRestart}>
          ...
          >
            <Path
              d="M4.75683 5.94765C7.32263 3.24068 10.9689 1.54974 15.014 1.54974C22.7816 1.54974 29.0785 7.78494 29.0785 15.4764C29.0785 23.168 22.7816 29.4031 15.014 29.4031C10.9689 29.4031 7.32263 27.7122 4.75683 25.0052M6.63899 10.0725L1.2251 10.0725L1.2251 4.71165"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
